            ...
            <div className="row">
              ...
              <div className="col-lg-8 mt-lg-0 mt-20">
                ...
                <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                  ...
                  {/* <FooterItem  title='Company' href={["/", "/", "/", "/#"]} items={["About Us", " Press Release", "Terms of Use","Privacy & Policy"]} />
                  <FooterItem  title="Support" href={["/", "", "/", "/#"]} items={["Refund Policy", "Unlock Rewards", "Live Chatting"]}/>
                  <FooterItem  title="Connect" href={["mailto: hi@store.gg", "mailto: team@store.gg", "http://maps.google.com/?q=Pasific 12,Jakarta Selatan", "tel: 02111229090"} items={["hi@store.gg", "team@store.gg", "Pasific 12,Jakarta Selatan", "021 - 1122 - 9090"]} /> */}
                </div>
              </div>
            </div>
          </div>
